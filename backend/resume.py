...
- POST /api/resume/analyze: Extracts text, sends to GPT-4o, returns diff + ATS scores
...
def _extract_keywords(text: str, top_n: int = 20) -> list[str]:
    ...
    # Also capture multi-word technical terms
    bigrams = []
...
async def analyze_resume(
    ...
    try:
        ...
        logger.error(f"GPT returned invalid JSON: {raw[:500]}")
        changes = []
